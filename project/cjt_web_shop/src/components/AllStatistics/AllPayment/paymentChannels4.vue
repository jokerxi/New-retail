<template>
  <div id="paymentChannels4">
    <div class="paymentChannels4-top">
    ...
    <!-- Echarts -->
    <div class="paymentChannels4-Echarts">
      <div id="paymentChannels4-Echarts"></div>
    </div>
    <!-- loading -->
...
export default {
  ...
  methods: {
    ...
    getData() {
      var st1
      this.$axios.get("../../../static/dataJson/paymentChannels4.json")
        .then(res => {
    ...
    tabData() {
      ...
      if (this.radio == '新增') {
        this.$axios.get("../../../static/dataJson/newpaymentChannels4.json")
          .then(res => {
            res.data.forEach(item => {
    ...
    paymentChannels4() {
      // 初始化
      let paymentChannels4 = this.$echarts.init(document.getElementById('paymentChannels4-Echarts'));
      // 绘图
      paymentChannels4.setOption({
        // 调色板
...
#paymentChannels4 {
  ...
  // Echarts修改样式
  #paymentChannels4-Echarts {
    min-height: 5rem;
  }

  #paymentChannels4-Echarts>div:nth-of-type(1) {
