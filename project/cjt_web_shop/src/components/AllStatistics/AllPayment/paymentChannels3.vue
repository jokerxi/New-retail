<template>
  <div id="paymentChannels3">
    <div class="paymentChannels3-top">
    ...
    <!-- Echarts -->
    <div class="paymentChannels3-Echarts">
      <div id="paymentChannels3-Echarts"></div>
    </div>
    <!-- loading -->
...
export default {
  ...
  methods: {
    ...
    getData() {
      var st1
      this.$axios.get("../../../static/dataJson/paymentChannels3.json")
        .then(res => {
    ...
    tabData() {
      ...
      if (this.radio == '新增') {
        this.$axios.get("../../../static/dataJson/newpaymentChannels3.json")
          .then(res => {
            res.data.forEach(item => {
    ...
    paymentChannels3() {
      // 初始化
      let paymentChannels3 = this.$echarts.init(document.getElementById('paymentChannels3-Echarts'));
      // 绘图
      paymentChannels3.setOption({
        // 调色板
...
#paymentChannels3 {
  ...
  // Echarts修改样式
  #paymentChannels3-Echarts {
    min-height: 5rem;
  }

  #paymentChannels3-Echarts>div:nth-of-type(1) {
