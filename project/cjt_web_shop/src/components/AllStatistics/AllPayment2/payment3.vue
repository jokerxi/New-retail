<template>
  <div id="payment3">
    ...
    <!-- Echarts -->
    <div class="payment3-Echarts">
      <div id="payment3-Echarts"></div>
    </div>
    <!-- loading -->
...
export default {
  ...
  methods: {
    ...
    getData() {
      var st1
      this.$axios.get("../../../static/dataJson/payment3.json")
        .then(res => {
    ...
    tabData() {
      ...
      if (this.radio == '新增') {
        this.$axios.get("../../../static/dataJson/newpayment3.json")
          .then(res => {
            res.data.forEach(item => {
    ...
    payment3() {
      // 初始化
      let payment3 = this.$echarts.init(document.getElementById('payment3-Echarts'));
      // 绘图
      payment3.setOption({
        // 调色板
...
#payment3 {
  ...
  #payment3-Echarts>div:nth-of-type(1) {
