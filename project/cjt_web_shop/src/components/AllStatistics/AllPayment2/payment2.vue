<template>
  <div id="payment2">
    ...
    <!-- Echarts -->
    <div class="payment2-Echarts">
      <div id="payment2-Echarts"></div>
    </div>
    <!-- loading -->
...
export default {
  ...
  methods: {
    ...
    getData() {
      var st1
      this.$axios.get("../../../static/dataJson/payment2.json")
        .then(res => {
    ...
    tabData() {
      ...
      if (this.radio == '新增') {
        this.$axios.get("../../../static/dataJson/newpayment2.json")
          .then(res => {
            res.data.forEach(item => {
    ...
    payment2() {
      // 初始化
      let payment2 = this.$echarts.init(document.getElementById('payment2-Echarts'));
      // 绘图
      payment2.setOption({
        // 调色板
...
#payment2 {
  ...
  #payment2-Echarts>div:nth-of-type(1) {
