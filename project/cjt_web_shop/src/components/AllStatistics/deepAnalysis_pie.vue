<template>
  <div id="deepAnalysis">
    <span class="deepAnalysis-title">{{slideinit.title}}</span>
    <div class="deepAnalysis-AllToDay">
      <div class="deepAnalysis-toDay">
      ...
      <!-- right-->
      <div class="deepAnalysis-toDayProfit">
...
#deepAnalysis {
  ...
  .deepAnalysis-AllToDay {
    display: flex;
    height: 2.8rem;

    // hover 效果
    .deepAnalysis-toDayProfit:hover,
    .deepAnalysis-toDay:hover {
